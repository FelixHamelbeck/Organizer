...
public class Dance_ViewHolder extends RecyclerView.ViewHolder implements Shouting {
    ...
    private final String TAG = "FEHA (Dance_ViewHolder)";
    ...
    Dance_Adapter mDance_Adapter = null;
...
//    }
    ...
    public void setDance_Adapter(Dance_Adapter dance_Adapter) {
