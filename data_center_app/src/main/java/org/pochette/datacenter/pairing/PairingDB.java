...
class PairingDB {
            ...
            try {
                ...
                if (tCursor != null) {
                    ...
                    while (tCursor.moveToNext()) {
                        ...
                        Logg.i(TAG, String.format(Locale.ENGLISH, "Mf %d Scddb %d %d",
                                tMfId, tRecordingId, tDanceId));
    ...
    public void updateMusicDirectory() {
        ...
        try {
            ...
            try {
                tCursor = tSqLiteDatabase.rawQuery(tSql, null);
                Logg.i(TAG, "Cursor " + tCursor.getCount());
                if (tCursor != null) {
                    Logg.i(TAG, "Add Cursor:" + tCursor.getCount());
                    ...
                    while (tCursor.moveToNext()) {
                        ...
                        Logg.i(TAG, String.format(Locale.ENGLISH, "Md %d Scddb %d", tMdId, tScddbId));
                        ContentValues tContentValues = new ContentValues();
