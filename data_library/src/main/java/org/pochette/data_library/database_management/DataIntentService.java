...
public class DataIntentService extends IntentService implements Shouting {
...
//    }
    ...
    public void downloadScddb(Shouting iShouting) {
        ...
        Thread tThread = new Thread(new Runnable() {
            @Override
            public void run() {
                Shout tShout = new Shout(DataIntentService.class.getSimpleName());
...
////                }
////                scanMusic(this.getApplicationContext(), this);
////            }
////        }
////
//
...
//        }
    ...
    public void prepareDatabase(boolean iDeleteLdb) {
        // SSL
        prepSSL(this.getApplicationContext());
        // LDB
        ...
        if (iDeleteLdb) {
            try {
                ...
                boolean tSuccess = this.getApplicationContext().deleteDatabase("Ldb");
                if (!tSuccess) {
